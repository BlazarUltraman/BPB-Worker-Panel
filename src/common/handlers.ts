...
// 代理函数（通用）
async function proxyAsset(remoteUrl: string, contentType: string): Promise<Response> {
    try {
...
export async function fallback(request: Request): Promise<Response> {
    ...
    // ----- 记分板伪装页面（优先级最高） -----
    const fakePageAssets: Record<string, { url: string; type: string }> = {
        '/': { url: 'https://framagit.org/Falcon/Source/-/raw/main/scoreboard/html.html', type: 'text/html' },
        '/css.css': { url: 'https://framagit.org/Falcon/Source/-/raw/main/scoreboard/css.css', type: 'text/css' },
        '/js.js': { url: 'https://framagit.org/Falcon/Source/-/raw/main/scoreboard/js.js', type: 'application/javascript' },
        '/teko.woff2': { url: 'https://framagit.org/Falcon/Source/-/raw/main/scoreboard/font.woff2', type: 'font/woff2' },
        '/teko.woff': { url: 'https://framagit.org/Falcon/Source/-/raw/main/scoreboard/font.woff', type: 'font/woff' },
        '/digital.woff2': { url: 'https://framagit.org/Falcon/Source/-/raw/main/scoreboard/DigitalNumbers-Regular.woff2', type: 'font/woff2' },
        '/digital.woff': { url: 'https://framagit.org/Falcon/Source/-/raw/main/scoreboard/DigitalNumbers-Regular.woff', type: 'font/woff' },
        '/audio.ogg': { url: 'https://framagit.org/Falcon/Source/-/raw/main/scoreboard/countdown.ogg', type: 'audio/ogg' },
        '/audio.mp3': { url: 'https://framagit.org/Falcon/Source/-/raw/main/scoreboard/countdown.mp3', type: 'audio/mpeg' },
    };

    const asset = fakePageAssets[pathname];
    if (asset) {
